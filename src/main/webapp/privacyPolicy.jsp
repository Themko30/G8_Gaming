...
<div class="content-wrap">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to D3Games.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to <a href="${pageContext.request.contextPath}/">D3Games</a></p>
        </li>
        <li>
    ...
    <ul>
        <li><a href="mailto:s.danese@studenti.unisa.it">s.danese@studenti.unisa.it</a></li>
        <li><a href="mailto:a.dalbenzio@studenti.unisa.it">a.dalbenzio@studenti.unisa.it</a></li>
        <li><a href="mailto:g.donisi1@studenti.unisa.it">g.donisi1@studenti.unisa.it</a></li>
    </ul>
</div>
</div>
